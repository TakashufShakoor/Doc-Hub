...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
      ...
      <button onClick={()=>{navigate('/doctors'); scrollTo(0,0)}} className='bg-[#C0E3FF] text-gray-600 px-5 py-1 md:px-12 md:py-3 rounded-full mt-10 hover:bg-opacity-80'  >More</button>
    </div>
  )
}
